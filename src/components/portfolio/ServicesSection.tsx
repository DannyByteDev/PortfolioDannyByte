  ...
  return (
    ...
    >
      <div className="relative preserve-3d rounded-2xl overflow-hidden">
        ...
        {isHovered && (
          <div
            className="absolute inset-0 z-10 pointer-events-none opacity-100 transition-opacity duration-300"
            style={{
              background: `radial-gradient(400px circle at ${mousePos.x}px ${mousePos.y}px, ${service.color}15, transparent 60%)`,
            }}
          />
        )}
